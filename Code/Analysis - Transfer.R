...
#################################################################################################
#### Assign a Coder to each wash ####
W000_G4_Dataset$Coder <- "W000"
W001_G4_Dataset$Coder <- "W001"
W002_G4_Dataset$Coder <- "W002"
W003_G4_Dataset$Coder <- "W003"
W004_G4_Dataset$Coder <- "W004"
W005_G4_Dataset$Coder <- "W005"
W006_G4_Dataset$Coder <- "W006"
W007_G4_Dataset$Coder <- "W007"
W008_G4_Dataset$Coder <- "W008"
W009_G4_Dataset$Coder <- "W009"
W010_G4_Dataset$Coder <- "W010"
W011_G4_Dataset$Coder <- "W011"

#########################################################
#####                     Controls                  #####
#########################################################
# Negative controls
W000negative <- W000_G4_Dataset %>% filter(grepl('negative', Sample))
W001negative <- W001_G4_Dataset %>% filter(grepl('negative', Sample))
W002negative <- W002_G4_Dataset %>% filter(grepl('negative', Sample))
W003negative <- W003_G4_Dataset %>% filter(grepl('negative', Sample))
W004negative <- W004_G4_Dataset %>% filter(grepl('negative', Sample))
W005negative <- W005_G4_Dataset %>% filter(grepl('negative', Sample))
W006negative <- W006_G4_Dataset %>% filter(grepl('negative', Sample))
W007negative <- W007_G4_Dataset %>% filter(grepl('negative', Sample))
W008negative <- W008_G4_Dataset %>% filter(grepl('negative', Sample))
W009negative <- W009_G4_Dataset %>% filter(grepl('negative', Sample))
W010negative <- W010_G4_Dataset %>% filter(grepl('negative', Sample))
W011negative <- W011_G4_Dataset %>% filter(grepl('negative', Sample))

# Create a data frame "Negativecontrol" with all the negative controls 
Negativecontrol <- rbind(W000negative,W001negative,W002negative,W003negative,W004negative,W005negative,W006negative,W007negative,W008negative,W009negative,W010negative,W011negative)
...
# Positive controls
W000positive <- W000_G4_Dataset %>% filter(grepl('positive', Sample))
W001positive <- W001_G4_Dataset %>% filter(grepl('positive', Sample))
W002positive <- W002_G4_Dataset %>% filter(grepl('positive', Sample))
W003positive <- W003_G4_Dataset %>% filter(grepl('positive', Sample))
W004positive <- W004_G4_Dataset %>% filter(grepl('positive', Sample))
W005positive <- W005_G4_Dataset %>% filter(grepl('positive', Sample))
W006positive <- W006_G4_Dataset %>% filter(grepl('positive', Sample))
W007positive <- W007_G4_Dataset %>% filter(grepl('positive', Sample))
W008positive <- W008_G4_Dataset %>% filter(grepl('positive', Sample))
W009positive <- W009_G4_Dataset %>% filter(grepl('positive', Sample))
W010positive <- W010_G4_Dataset %>% filter(grepl('positive', Sample))
W011positive <- W011_G4_Dataset %>% filter(grepl('positive', Sample))

Positivecontrol <- rbind(W000positive,W001positive,W002positive,W003positive,W004positive,W005positive,W006positive,W007positive,W008positive,W009positive,W010positive,W011positive)
Positivecontrol$Diff <- Positivecontrol$`After transfer` - Positivecontrol$`Before transfer`
...
#### Creating dataset with only column Coder and After transfer after removing the positive and negative control ####
forFibreCount0<- W000_G4_Dataset[!(W000_G4_Dataset$Sample=="MP_W000_G4_positive_B" | W000_G4_Dataset$Sample=="MP_W000_G4_negative_B"),]
forFibreCount1<- W001_G4_Dataset[!(W001_G4_Dataset$Sample=="MP_W001_G4_positive_B" | W001_G4_Dataset$Sample=="MP_W001_G4_negative_B"),]
forFibreCount2<- W002_G4_Dataset[!(W002_G4_Dataset$Sample=="MP_W002_G4_positive_B" | W002_G4_Dataset$Sample=="MP_W002_G4_negative_B"),]
forFibreCount3<- W003_G4_Dataset[!(W003_G4_Dataset$Sample=="MP_W003_G4_positive_B" | W003_G4_Dataset$Sample=="MP_W003_G4_negative_B"),]
forFibreCount4<- W004_G4_Dataset[!(W004_G4_Dataset$Sample=="MP_W004_G4_positive_B" | W004_G4_Dataset$Sample=="MP_W004_G4_negative_B"),]
forFibreCount5<- W005_G4_Dataset[!(W005_G4_Dataset$Sample=="MP_W005_G4_positive_B" | W005_G4_Dataset$Sample=="MP_W005_G4_negative_B"),]
forFibreCount6<- W006_G4_Dataset[!(W006_G4_Dataset$Sample=="MP_W006_G4_positive_B" | W006_G4_Dataset$Sample=="MP_W006_G4_negative_B"),]
forFibreCount7<- W007_G4_Dataset[!(W007_G4_Dataset$Sample=="MP_W007_G4_positive_B" | W007_G4_Dataset$Sample=="MP_W007_G4_negative_B"),]
forFibreCount8<- W008_G4_Dataset[!(W008_G4_Dataset$Sample=="MP_W008_G4_positive_B" | W008_G4_Dataset$Sample=="MP_W008_G4_negative_B"),]
forFibreCount9<- W009_G4_Dataset[!(W009_G4_Dataset$Sample=="MP_W009_G4_positive_B" | W009_G4_Dataset$Sample=="MP_W009_G4_negative_B"),]
forFibreCount10<- W010_G4_Dataset[!(W010_G4_Dataset$Sample=="MP_W010_G4_positive_B" | W010_G4_Dataset$Sample=="MP_W010_G4_negative_B"),]
forFibreCount11<- W011_G4_Dataset[!(W011_G4_Dataset$Sample=="MP_W011_G4_positive_B" | W011_G4_Dataset$Sample=="MP_W011_G4_negative_B"),]
...
#### Combine all the dataframe ####
BackgroundFibreCount <- rbind(BackgroundW000,BackgroundW001,BackgroundW002,BackgroundW003,BackgroundW004,BackgroundW005,BackgroundW006,BackgroundW007,BackgroundW008,BackgroundW009,BackgroundW010,BackgroundW011)
names(BackgroundFibreCount) <- c("group", "value")
# write.table(TransferFibreCount, file = "Fibre Count - Transfer.csv", quote = F, sep = ",", row.names = F)
...
#### Combine all the dataframe ####
TransferFibreCount_G4 <- rbind(TransferW000,TransferW001,TransferW002,TransferW003,TransferW004,TransferW005,TransferW006,TransferW007,TransferW008,TransferW009,TransferW010,TransferW011)
