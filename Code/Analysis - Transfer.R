...
W015negative <- W015_G1_Dataset %>% filter(grepl('negative', Sample))

# Create a data frame "Negativecontrol" with all the negative controls 
Negativecontrol <- rbind(W000negative,W001negative, W002negative,W003negative,W004negative,W005negative,W006negative,W007negative,W009negative,W011negative,W013negative,W015negative)
...
W015positive <- W015_G1_Dataset %>% filter(grepl('positive', Sample))

Positivecontrol <- rbind(W000positive,W001positive, W002positive, W003positive, W004positive, W005positive,W006positive,W007positive,W009positive,W011positive,W013positive,W015positive)
...
forFibreCount15<- W015_G1_Dataset[!(W015_G1_Dataset$Sample=="MP_W015_G1_positive_B" | W015_G1_Dataset$Sample=="MP_W015_G1_negative_B"),]
...
BackgroundFibreCount <- rbind(BackgroundW000, BackgroundW001, BackgroundW002,BackgroundW003,BackgroundW004,
                              BackgroundW005,BackgroundW006,BackgroundW007,BackgroundW009,BackgroundW011,BackgroundW013,BackgroundW015)
...
TransferFibreCount_G1 <- rbind(TransferW000, TransferW001, TransferW002,TransferW003,TransferW004,TransferW005,
                            TransferW006,TransferW007,TransferW009,TransferW011,TransferW013,TransferW015)
...
W011_G4A_Dataset$Coder <- "W011"
W012_G4A_Dataset$Coder <- "W012"
W013_G4A_Dataset$Coder <- "W013"
W014_G4A_Dataset$Coder <- "W014"
W015_G4A_Dataset$Coder <- "W015"
...
W011negative <- W011_G4A_Dataset %>% filter(grepl('negative', Sample))
W012negative <- W012_G4A_Dataset %>% filter(grepl('negative', Sample))
W013negative <- W013_G4A_Dataset %>% filter(grepl('negative', Sample))
W014negative <- W014_G4A_Dataset %>% filter(grepl('negative', Sample))
W015negative <- W015_G4A_Dataset %>% filter(grepl('negative', Sample))

# Create a data frame "Negativecontrol" with all the negative controls 
Negativecontrol <- rbind(W000negative,W001negative,W002negative,W003negative,W004negative,W005negative,W006negative,W007negative,W008negative,W009negative,W010negative,W011negative,W012negative,W013negative,W014negative,W015negative)
...
W011positive <- W011_G4A_Dataset %>% filter(grepl('positive', Sample))
W012positive <- W012_G4A_Dataset %>% filter(grepl('positive', Sample))
W013positive <- W013_G4A_Dataset %>% filter(grepl('positive', Sample))
W014positive <- W014_G4A_Dataset %>% filter(grepl('positive', Sample))
W015positive <- W015_G4A_Dataset %>% filter(grepl('positive', Sample))

Positivecontrol <- rbind(W000positive,W001positive,W002positive,W003positive,W004positive,W005positive,W006positive,W007positive,W008positive,W009positive,W010positive,W011positive,W012positive,W013positive,W014positive,W015positive)
Positivecontrol$Diff <- Positivecontrol$`After transfer` - Positivecontrol$`Before transfer`
...
forFibreCount11<- W011_G4A_Dataset[!(W011_G4A_Dataset$Sample=="MP_W011_G4A_positive_B" | W011_G4A_Dataset$Sample=="MP_W011_G4A_negative_B"),]
forFibreCount12<- W012_G4A_Dataset[!(W012_G4A_Dataset$Sample=="MP_W012_G4A_positive_B" | W012_G4A_Dataset$Sample=="MP_W012_G4A_negative_B"),]
forFibreCount13<- W013_G4A_Dataset[!(W013_G4A_Dataset$Sample=="MP_W013_G4A_positive_B" | W013_G4A_Dataset$Sample=="MP_W013_G4A_negative_B"),]
forFibreCount14<- W014_G4A_Dataset[!(W014_G4A_Dataset$Sample=="MP_W014_G4A_positive_B" | W014_G4A_Dataset$Sample=="MP_W014_G4A_negative_B"),]
forFibreCount15<- W015_G4A_Dataset[!(W015_G4A_Dataset$Sample=="MP_W015_G4A_positive_B" | W015_G4A_Dataset$Sample=="MP_W015_G4A_negative_B"),]
...
#### Combine all the dataframe ####
BackgroundFibreCount <- rbind(BackgroundW000,BackgroundW001,BackgroundW002,BackgroundW003,BackgroundW004,BackgroundW005,BackgroundW006,BackgroundW007,BackgroundW008,BackgroundW009,BackgroundW010,BackgroundW011,BackgroundW012,BackgroundW013,BackgroundW014,BackgroundW015)
names(BackgroundFibreCount) <- c("group", "value")
# write.table(TransferFibreCount, file = "Fibre Count - Transfer.csv", quote = F, sep = ",", row.names = F)
...
#### Combine all the dataframe ####
TransferFibreCount_G4A <- rbind(TransferW000,TransferW001,TransferW002,TransferW003,TransferW004,TransferW005,TransferW006,TransferW007,TransferW008,TransferW009,TransferW010,TransferW011,TransferW012,TransferW013,TransferW014,TransferW015)
...
W011_G4B_Dataset$Coder <- "W011"
W012_G4B_Dataset$Coder <- "W012"
W013_G4B_Dataset$Coder <- "W013"
W014_G4B_Dataset$Coder <- "W014"
W015_G4B_Dataset$Coder <- "W015"
...
W011negative <- W011_G4B_Dataset %>% filter(grepl('negative', Sample))
W012negative <- W012_G4B_Dataset %>% filter(grepl('negative', Sample))
W013negative <- W013_G4B_Dataset %>% filter(grepl('negative', Sample))
W014negative <- W014_G4B_Dataset %>% filter(grepl('negative', Sample))
W015negative <- W015_G4B_Dataset %>% filter(grepl('negative', Sample))
...
W011positive <- W011_G4B_Dataset %>% filter(grepl('positive', Sample))
W012positive <- W012_G4B_Dataset %>% filter(grepl('positive', Sample))
W013positive <- W013_G4B_Dataset %>% filter(grepl('positive', Sample))
W014positive <- W014_G4B_Dataset %>% filter(grepl('positive', Sample))
W015positive <- W015_G4B_Dataset %>% filter(grepl('positive', Sample))
...
forFibreCount11<- W011_G4B_Dataset[!(W011_G4B_Dataset$Sample=="MP_W011_G4B_positive_B" | W011_G4B_Dataset$Sample=="MP_W011_G4B_negative_B"),]
forFibreCount12<- W012_G4B_Dataset[!(W012_G4B_Dataset$Sample=="MP_W012_G4B_positive_B" | W012_G4B_Dataset$Sample=="MP_W012_G4B_negative_B"),]
forFibreCount13<- W013_G4B_Dataset[!(W013_G4B_Dataset$Sample=="MP_W013_G4B_positive_B" | W013_G4B_Dataset$Sample=="MP_W013_G4B_negative_B"),]
forFibreCount14<- W014_G4B_Dataset[!(W014_G4B_Dataset$Sample=="MP_W014_G4B_positive_B" | W014_G4B_Dataset$Sample=="MP_W014_G4B_negative_B"),]
forFibreCount15<- W015_G4B_Dataset[!(W015_G4B_Dataset$Sample=="MP_W015_G4B_positive_B" | W015_G4B_Dataset$Sample=="MP_W015_G4B_negative_B"),]
...
#### Combine all the dataframe ####
TransferFibreCount_G4B <- rbind(TransferW000,TransferW001,TransferW002,TransferW003,TransferW004,TransferW005,TransferW006,TransferW007,TransferW008,TransferW009,TransferW010,TransferW011,TransferW012,TransferW013,TransferW014,TransferW015)
...
W011_G4C_Dataset$Coder <- "W011"
W012_G4C_Dataset$Coder <- "W012"
W013_G4C_Dataset$Coder <- "W013"
W014_G4C_Dataset$Coder <- "W014"
W015_G4C_Dataset$Coder <- "W015"
...
W011negative <- W011_G4C_Dataset %>% filter(grepl('negative', Sample))
W012negative <- W012_G4C_Dataset %>% filter(grepl('negative', Sample))
W013negative <- W013_G4C_Dataset %>% filter(grepl('negative', Sample))
W014negative <- W014_G4C_Dataset %>% filter(grepl('negative', Sample))
W015negative <- W015_G4C_Dataset %>% filter(grepl('negative', Sample))
...
W011positive <- W011_G4C_Dataset %>% filter(grepl('positive', Sample))
W012positive <- W012_G4C_Dataset %>% filter(grepl('positive', Sample))
W013positive <- W013_G4C_Dataset %>% filter(grepl('positive', Sample))
W014positive <- W014_G4C_Dataset %>% filter(grepl('positive', Sample))
W015positive <- W015_G4C_Dataset %>% filter(grepl('positive', Sample))
...
forFibreCount11<- W011_G4C_Dataset[!(W011_G4C_Dataset$Sample=="MP_W011_G4C_positive_B" | W011_G4C_Dataset$Sample=="MP_W011_G4C_negative_B"),]
forFibreCount12<- W012_G4C_Dataset[!(W012_G4C_Dataset$Sample=="MP_W012_G4C_positive_B" | W012_G4C_Dataset$Sample=="MP_W012_G4C_negative_B"),]
forFibreCount13<- W013_G4C_Dataset[!(W013_G4C_Dataset$Sample=="MP_W013_G4C_positive_B" | W013_G4C_Dataset$Sample=="MP_W013_G4C_negative_B"),]
forFibreCount14<- W014_G4C_Dataset[!(W014_G4C_Dataset$Sample=="MP_W014_G4C_positive_B" | W014_G4C_Dataset$Sample=="MP_W014_G4C_negative_B"),]
forFibreCount15<- W015_G4C_Dataset[!(W015_G4C_Dataset$Sample=="MP_W015_G4C_positive_B" | W015_G4C_Dataset$Sample=="MP_W015_G4C_negative_B"),]
...
#### Combine all the dataframe ####
TransferFibreCount_G4C <- rbind(TransferW000,TransferW001,TransferW002,TransferW003,TransferW004,TransferW005,TransferW006,TransferW007,TransferW008,TransferW009,TransferW010,TransferW011,TransferW012,TransferW013,TransferW014,TransferW015)
...
#### Combine all the dataframe ####
TransferFibreCount_G4 <- rbind(TransferFibreCount_G4A,TransferFibreCount_G4B,TransferFibreCount_G4C)
names(TransferFibreCount_G4) <- c("group", "value")
# write.table(TransferFibreCount_G4A, file = "Fibre Count - Transfer.csv", quote = F, sep = ",", row.names = F)

#### Bar plots of data by group - distribution ####
histogram(~ value | group,data=TransferFibreCount_G4,layout=c(3,3),
          xlab="Number of fibres")

#### Create a table with descriptive statistics ####
meanAtr_G4 <- aggregate(value ~  group, TransferFibreCount_G4, function(x) {round(mean(x), digits=2)})
SDAtr_G4 <- aggregate(value ~  group, TransferFibreCount_G4, function(x) {round(SD(x), digits=2)})
SD2Atr_G4 <- round(sqrt((SDAtr_G4$value^2)+(0.95^2)),digits=2)
medianAtr_G4 <- aggregate(value ~  group, TransferFibreCount_G4, median)
