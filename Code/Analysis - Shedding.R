...
#####   G1   #####
##################
Shedding_G1 <- read.csv('./Fibre count Summary/SH_G1_W000-W007_Summary.csv', sep="," ,header = T,fileEncoding="UTF-8-BOM")
...
FibreCount_Shedding_G1 <- rbind(DataW000_G1_total,DataW001_G1_total,DataW003_G1_total,DataW005_G1_total,DataW007_G1_total)
...
pSH <- ggplot(FibreCount_Shedding_G1, aes(x = factor(Weight, level = c('100g', '200g', '400g','800g','1000g','2000g')),
  ...
  scale_fill_manual("legend", values = c("W000_G1" = "#FED976", "W001_G1" = "#FEB24C","W003_G1" = "#FD8D3C",
                                         "W005_G1" = "#FC4E2A","W007_G1" = "#E31A1C"))+ # to obtain the colour brewer.pal(9, "YlOrRd")
...
#####   G2   #####
##################
Shedding_G2 <- read.csv('./Fibre count Summary/SH_G2_W000-W011_Summary.csv', sep="," ,header = T,fileEncoding="UTF-8-BOM")
...
FibreCount_Shedding_G2 <- rbind(DataW000_G2_total,DataW001_G2_total,DataW003_G2_total, DataW005total,DataW007total,DataW009total,DataW011total)
...
pSH <- ggplot(FibreCount_Shedding_G2, aes(x = factor(Weight, level = c('100g', '200g', '400g','800g','1000g','2000g')),
  ...
  theme_bw(base_family = "Arial", base_size = 12) +
  ylim(0,500)+
  scale_fill_manual("legend", values = c("W000_G2" = "#A6CEE3", "W001_G2" = "#1F78B4","W003_G2" = "#B2DF8A", "W005_G2" = "#5e8a37", "W007_G2" = "#9e8adf", "W009_G2" = "#564982", "W011_G2" = "#e6de9a"))+ # to obtain the colour brewer.pal(12, "Paired")
  theme(legend.title = element_blank(),
        strip.background.x = element_rect(colour = "grey", fill = "white"),
        legend.position = "bottom",
        legend.background = element_rect(fill="grey95",size=1, linetype="solid", colour="grey80"),
  ...
  geom_errorbar(aes(ymin=meanArea-SD, ymax=meanArea+SD),width=.2,position=position_dodge(.9))
pSH
ggsave("Shedding_G2_W000-11.png", pSH, width = 10, height = 9, units = "in", dpi=150, path = "Results")

##################
#####   G3   #####
##################
Shedding_G3 <- read.csv('./Fibre count Summary/SH_G3_W000-W001_Summary.csv', sep="," ,header = T,fileEncoding="UTF-8-BOM")
...
FibreCount_Shedding_G3 <- rbind(DataW000_G3_total,DataW001_G3_total) #,DataW003_G3_total, DataW005total,DataW007total,DataW009total,DataW011total)
...
pSH <- ggplot(FibreCount_Shedding_G3, aes(x = factor(Weight, level = c('100g', '200g', '400g','800g','1000g','2000g')),
  ...
  theme_bw(base_family = "Arial", base_size = 12) +
  ylim(0,500)+
  scale_fill_manual("legend", values = c("W000_G3" = "#A6CEE3", "W001_G3" = "#1F78B4"))+ # to obtain the colour brewer.pal(12, "Paired")
  theme(legend.title = element_blank(),
        strip.background.x = element_rect(colour = "grey", fill = "white"),
        legend.position = "bottom",
        legend.background = element_rect(fill="grey95",size=1, linetype="solid", colour="grey80"),
  ...
  geom_errorbar(aes(ymin=meanArea-SD, ymax=meanArea+SD),width=.2,position=position_dodge(.9))
pSH
ggsave("Shedding_G3_W000-1.png", pSH, width = 10, height = 9, units = "in", dpi=150, path = "Results")


##################
####   G4A    ####
##################
Shedding_G4A <- read.csv('./Fibre count Summary/SH_G4A_W000_Summary.csv', sep="," ,header = T,fileEncoding="UTF-8-BOM")
...
####   G4B    ####
##################
Shedding_G4B <- read.csv('./Fibre count Summary/SH_G4B_W000_Summary.csv', sep="," ,header = T,fileEncoding="UTF-8-BOM")
