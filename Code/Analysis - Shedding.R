...
####    G4    ####
##################
Shedding_G4 <- read.csv('./Fibre count Summary/SH_G4_W000-W015_Summary.csv', sep="," ,header = T,fileEncoding="UTF-8-BOM")
...
DataAreaW013_G4 <- Shedding_G4Total[Shedding_G4Total$Wash =='W013',]
DataAreaW015_G4 <- Shedding_G4Total[Shedding_G4Total$Wash =='W015',]
...
DataAreaW013_G4_100 <- DataAreaW013_G4[DataAreaW013_G4$Weight =='100g',]
DataAreaW013_G4_200 <- DataAreaW013_G4[DataAreaW013_G4$Weight =='200g',]
DataAreaW013_G4_400 <- DataAreaW013_G4[DataAreaW013_G4$Weight =='400g',]
DataAreaW013_G4_800 <- DataAreaW013_G4[DataAreaW013_G4$Weight =='800g',]
DataAreaW013_G4_1000 <- DataAreaW013_G4[DataAreaW013_G4$Weight =='1000g',]
DataAreaW013_G4_2000 <- DataAreaW013_G4[DataAreaW013_G4$Weight =='2000g',]

DataAreaW015_G4_100 <- DataAreaW015_G4[DataAreaW015_G4$Weight =='100g',]
DataAreaW015_G4_200 <- DataAreaW015_G4[DataAreaW015_G4$Weight =='200g',]
DataAreaW015_G4_400 <- DataAreaW015_G4[DataAreaW015_G4$Weight =='400g',]
DataAreaW015_G4_800 <- DataAreaW015_G4[DataAreaW015_G4$Weight =='800g',]
DataAreaW015_G4_1000 <- DataAreaW015_G4[DataAreaW015_G4$Weight =='1000g',]
DataAreaW015_G4_2000 <- DataAreaW015_G4[DataAreaW015_G4$Weight =='2000g',]
...
meanDataAreaW013_G4_100<- data.frame(meanArea=round(mean(DataAreaW013_G4_100$Area.mm2),digits =2 ))
meanDataAreaW013_G4_100$SD<- round(sd(DataAreaW013_G4_100$Area.mm2),digits =2 )
meanDataAreaW013_G4_100$Weight <- "100g"
meanDataAreaW013_G4_200<- data.frame(meanArea=round(mean(DataAreaW013_G4_200$Area.mm2),digits =2 ))
meanDataAreaW013_G4_200$SD<- round(sd(DataAreaW013_G4_200$Area.mm2),digits =2 )
meanDataAreaW013_G4_200$Weight <- "200g"
meanDataAreaW013_G4_400<- data.frame(meanArea=round(mean(DataAreaW013_G4_400$Area.mm2),digits =2 ))
meanDataAreaW013_G4_400$SD<- round(sd(DataAreaW013_G4_400$Area.mm2),digits =2 )
meanDataAreaW013_G4_400$Weight <- "400g"
meanDataAreaW013_G4_800<- data.frame(meanArea=round(mean(DataAreaW013_G4_800$Area.mm2),digits =2 ))
meanDataAreaW013_G4_800$SD<- round(sd(DataAreaW013_G4_800$Area.mm2),digits =2 )
meanDataAreaW013_G4_800$Weight <- "800g"
meanDataAreaW013_G4_1000<- data.frame(meanArea=round(mean(DataAreaW013_G4_1000$Area.mm2),digits =2 ))
meanDataAreaW013_G4_1000$SD<- round(sd(DataAreaW013_G4_1000$Area.mm2),digits =2 )
meanDataAreaW013_G4_1000$Weight <- "1000g"
meanDataAreaW013_G4_2000<- data.frame(meanArea=round(mean(DataAreaW013_G4_2000$Area.mm2),digits =2 ))
meanDataAreaW013_G4_2000$SD<- round(sd(DataAreaW013_G4_2000$Area.mm2),digits =2 )
meanDataAreaW013_G4_2000$Weight <- "2000g"

meanDataAreaW015_G4_100<- data.frame(meanArea=round(mean(DataAreaW015_G4_100$Area.mm2),digits =2 ))
meanDataAreaW015_G4_100$SD<- round(sd(DataAreaW015_G4_100$Area.mm2),digits =2 )
meanDataAreaW015_G4_100$Weight <- "100g"
meanDataAreaW015_G4_200<- data.frame(meanArea=round(mean(DataAreaW015_G4_200$Area.mm2),digits =2 ))
meanDataAreaW015_G4_200$SD<- round(sd(DataAreaW015_G4_200$Area.mm2),digits =2 )
meanDataAreaW015_G4_200$Weight <- "200g"
meanDataAreaW015_G4_400<- data.frame(meanArea=round(mean(DataAreaW015_G4_400$Area.mm2),digits =2 ))
meanDataAreaW015_G4_400$SD<- round(sd(DataAreaW015_G4_400$Area.mm2),digits =2 )
meanDataAreaW015_G4_400$Weight <- "400g"
meanDataAreaW015_G4_800<- data.frame(meanArea=round(mean(DataAreaW015_G4_800$Area.mm2),digits =2 ))
meanDataAreaW015_G4_800$SD<- round(sd(DataAreaW015_G4_800$Area.mm2),digits =2 )
meanDataAreaW015_G4_800$Weight <- "800g"
meanDataAreaW015_G4_1000<- data.frame(meanArea=round(mean(DataAreaW015_G4_1000$Area.mm2),digits =2 ))
meanDataAreaW015_G4_1000$SD<- round(sd(DataAreaW015_G4_1000$Area.mm2),digits =2 )
meanDataAreaW015_G4_1000$Weight <- "1000g"
meanDataAreaW015_G4_2000<- data.frame(meanArea=round(mean(DataAreaW015_G4_2000$Area.mm2),digits =2 ))
meanDataAreaW015_G4_2000$SD<- round(sd(DataAreaW015_G4_2000$Area.mm2),digits =2 )
meanDataAreaW015_G4_2000$Weight <- "2000g"
...
DataW013_G4_total <- rbind(meanDataAreaW013_G4_100,meanDataAreaW013_G4_200,meanDataAreaW013_G4_400,
                           meanDataAreaW013_G4_800,meanDataAreaW013_G4_1000,meanDataAreaW013_G4_2000)
DataW013_G4_total$Condition <- "W013_G4"

DataW015_G4_total <- rbind(meanDataAreaW015_G4_100,meanDataAreaW015_G4_200,meanDataAreaW015_G4_400,
                           meanDataAreaW015_G4_800,meanDataAreaW015_G4_1000,meanDataAreaW015_G4_2000)
DataW015_G4_total$Condition <- "W015_G4"

FibreCount_Shedding_G4 <- rbind(DataW000_G4_total,DataW001_G4_total,DataW003_G4_total,DataW005_G4_total,DataW007_G4_total,DataW009_G4_total,DataW011_G4_total,DataW013_G4_total,DataW015_G4_total)
...
pSH_G4 <- ggplot(FibreCount_Shedding_G4, aes(x = factor(Weight, level = c('100g', '200g', '400g','800g','1000g','2000g')),
  ...
  geom_errorbar(aes(ymin=meanArea-SD, ymax=meanArea+SD),width=.2,position=position_dodge(.9))
pSH_G4
ggsave("Shedding_G4_W000-15.png", pSH_G4, width = 10, height = 9, units = "in", dpi=150, path = "Results")
...
pSH_G4 <- ggplot(FibreCount_Shedding_G4, aes(x = factor(Weight, level = c('100g', '200g', '400g','800g','1000g','2000g')),
  ...
  geom_errorbar(aes(ymin=meanArea-SD, ymax=meanArea+SD),width=.2,position=position_dodge(.9))
pSH_G4
ggsave("Shedding_G4_W000-13_No Mean Label.png", pSH_G4, width = 10, height = 9, units = "in", dpi=150, path = "Results")


#######################
####   COMBINED    ####
#######################
# Combined results - figure 2
pSH_figure2_pending <- ggarrange(pSH_G1+ rremove("ylab") + rremove("xlab"),
...
ppSH_combined <- annotate_figure(pSH_figure2_pending, left = textGrob("Total fibre area (mm\u00b2)\n", rot = 90, vjust = 0.5, hjust = 0.5, gp = gpar(cex =1)),
                                  bottom = textGrob("\nWeight", vjust = 0.5, hjust = 0.5,gp = gpar(cex = 1)));ppSH_combined

ggsave("ppSH_figure2.png", ppSH_combined, width = 7, height = 6, units = "in", dpi=300, path = "Results")

# Combined results - figure 2
pSH_figure3_pending <- ggarrange(pSH_G2+ rremove("ylab") + rremove("xlab"),
...
ppSH_combined <- annotate_figure(pSH_figure3_pending, left = textGrob("Total fibre area (mm\u00b2)\n", rot = 90, vjust = 0.5, hjust = 0.5, gp = gpar(cex =1)),
                                 bottom = textGrob("\nWeight", vjust = 0.5, hjust = 0.5,gp = gpar(cex = 1)));ppSH_combined

ggsave("ppSH_figure3.png", ppSH_combined, width = 7, height = 6, units = "in", dpi=300, path = "Results")
