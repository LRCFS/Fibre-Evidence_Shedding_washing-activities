...
#####   G1   #####
##################
TransferArea_G1 <- read.csv('./Fibre count Summary/TR_G1_W000-W013_Summary.csv', sep="," ,header = T,fileEncoding="UTF-8-BOM")
...
FibreCount_TransferArea_G1 <- rbind(meanDataAreaW000_G1_TR, meanDataAreaW001_G1_TR, meanDataAreaW003_G1_TR, meanDataAreaW005_G1_TR, meanDataAreaW007_G1_TR,meanDataAreaW009_G1_TR,meanDataAreaW011_G1_TR,meanDataAreaW013_G1_TR)

#write.table(FibreCount_TransferArea_G1, file = "Transfer_Area.csv", quote = F, sep = ",", row.names = F)

# plot
pSH_G1 <- ggplot(FibreCount_TransferArea_G1, aes(x = factor(Wash, level = c('W000','W001','W003','W005','W007','W009','W011','W013')),
...
pSH_G1
ggsave("TransferArea_G1_W000-13.png", pSH_G1, width = 10, height = 9, units = "in", dpi=150, path = "Results")
...
# plot
pSH_G2 <- ggplot(FibreCount_TransferArea_G2, aes(x = factor(Wash, level = c('W000', 'W001','W003','W005','W007','W009','W010','W013','W015')),
                                                 y= meanArea, fill=Condition))+
  geom_bar(stat="identity", position=position_dodge(),colour="black")+
  geom_text(aes(label = meanArea), hjust=0.5,vjust = -5.5,position = position_dodge(.9))+
  labs(x="\nWash", y="Total fibre area (mm\u00b2)\n") +
...
# plot
pSH_G3 <- ggplot(FibreCount_TransferArea_G3, aes(x = factor(Wash, level = c('W000','W001','W003','W005','W007','W009','W010','W013','W015')),
                                                 y= meanArea, fill=Condition))+
  geom_bar(stat="identity", position=position_dodge(),colour="black")+
  geom_text(aes(label = meanArea), hjust=0.5,vjust = -5.5,position = position_dodge(.9))+
  labs(x="\nWash", y="Total fibre area (mm\u00b2)\n") +
  ...
  geom_errorbar(aes(ymin=meanArea-SD, ymax=meanArea+SD),width=.2,position=position_dodge(.9))
pSH_G3
ggsave("TransferArea_G3_W000-15.png", pSH_G3, width = 10, height = 9, units = "in", dpi=150, path = "Results")

###################
#####   G4A   #####
###################
TransferArea_G4A <- read.csv('./Fibre count Summary/TR_G4A_W000-W007_Summary.csv', sep="," ,header = T,fileEncoding="UTF-8-BOM")
TransferArea_G4A$Slice<- gsub(".TIF","",TransferArea_G4A$Slice)
TransferArea_G4AExtended <- data.frame(str_split(TransferArea_G4A$Slice, "_", simplify=TRUE))
names(TransferArea_G4AExtended) <- c("Project","Wash","Garment","Bound","Condition")
TransferArea_G4ATotal <- cbind(TransferArea_G4AExtended,Area=TransferArea_G4A$Total.Area)

# Convert Area from inch2 to mm2
# 1 pixel = 1 x10^-5 inch2, so (Area*1)/0.000011 to convert into px
TransferArea_G4ATotal$Area.px <- (TransferArea_G4ATotal$Area*1)/0.000011
# 1 mm = 112 pixels, 1mm2 = 12544 px
TransferArea_G4ATotal$Area.mm2 <- TransferArea_G4ATotal$Area.px/12544

# Split data per washing condition
DataAreaW000_G4A_TR <- TransferArea_G4ATotal[TransferArea_G4ATotal$Wash =='W000',]
DataAreaW001_G4A_TR <- TransferArea_G4ATotal[TransferArea_G4ATotal$Wash =='W001',]
DataAreaW003_G4A_TR <- TransferArea_G4ATotal[TransferArea_G4ATotal$Wash =='W003',]
DataAreaW005_G4A_TR <- TransferArea_G4ATotal[TransferArea_G4ATotal$Wash =='W005',]
DataAreaW007_G4A_TR <- TransferArea_G4ATotal[TransferArea_G4ATotal$Wash =='W007',]
DataAreaW009_G4A_TR <- TransferArea_G4ATotal[TransferArea_G4ATotal$Wash =='W009',]
DataAreaW010_G4A_TR <- TransferArea_G4ATotal[TransferArea_G4ATotal$Wash =='W010',]
DataAreaW013_G4A_TR <- TransferArea_G4ATotal[TransferArea_G4ATotal$Wash =='W013',]
DataAreaW015_G4A_TR <- TransferArea_G4ATotal[TransferArea_G4ATotal$Wash =='W015',]

# Calculation of mean and SD
meanDataAreaW000_G4A_TR<- data.frame(meanArea=round(mean(DataAreaW000_G4A_TR$Area.mm2),digits =2 ))
meanDataAreaW000_G4A_TR$SD<- round(sd(DataAreaW000_G4A_TR$Area.mm2),digits =2 )
meanDataAreaW000_G4A_TR$Wash <- "W000"
meanDataAreaW000_G4A_TR$Condition <- "W000_G4A"

meanDataAreaW001_G4A_TR<- data.frame(meanArea=round(mean(DataAreaW001_G4A_TR$Area.mm2),digits =2 ))
meanDataAreaW001_G4A_TR$SD<- round(sd(DataAreaW001_G4A_TR$Area.mm2),digits =2 )
meanDataAreaW001_G4A_TR$Wash <- "W001"
meanDataAreaW001_G4A_TR$Condition <- "W001_G4A"

meanDataAreaW003_G4A_TR<- data.frame(meanArea=round(mean(DataAreaW003_G4A_TR$Area.mm2),digits =2 ))
meanDataAreaW003_G4A_TR$SD<- round(sd(DataAreaW003_G4A_TR$Area.mm2),digits =2 )
meanDataAreaW003_G4A_TR$Wash <- "W003"
meanDataAreaW003_G4A_TR$Condition <- "W003_G4A"

meanDataAreaW005_G4A_TR<- data.frame(meanArea=round(mean(DataAreaW005_G4A_TR$Area.mm2),digits =2 ))
meanDataAreaW005_G4A_TR$SD<- round(sd(DataAreaW005_G4A_TR$Area.mm2),digits =2 )
meanDataAreaW005_G4A_TR$Wash <- "W005"
meanDataAreaW005_G4A_TR$Condition <- "W005_G4A"

meanDataAreaW007_G4A_TR<- data.frame(meanArea=round(mean(DataAreaW007_G4A_TR$Area.mm2),digits =2 ))
meanDataAreaW007_G4A_TR$SD<- round(sd(DataAreaW007_G4A_TR$Area.mm2),digits =2 )
meanDataAreaW007_G4A_TR$Wash <- "W007"
meanDataAreaW007_G4A_TR$Condition <- "W007_G4A"

meanDataAreaW009_G4A_TR<- data.frame(meanArea=round(mean(DataAreaW009_G4A_TR$Area.mm2),digits =2 ))
meanDataAreaW009_G4A_TR$SD<- round(sd(DataAreaW009_G4A_TR$Area.mm2),digits =2 )
meanDataAreaW009_G4A_TR$Wash <- "W009"
meanDataAreaW009_G4A_TR$Condition <- "W009_G4A"

meanDataAreaW010_G4A_TR<- data.frame(meanArea=round(mean(DataAreaW010_G4A_TR$Area.mm2),digits =2 ))
meanDataAreaW010_G4A_TR$SD<- round(sd(DataAreaW010_G4A_TR$Area.mm2),digits =2 )
meanDataAreaW010_G4A_TR$Wash <- "W010"
meanDataAreaW010_G4A_TR$Condition <- "W010_G4A"

meanDataAreaW013_G4A_TR<- data.frame(meanArea=round(mean(DataAreaW013_G4A_TR$Area.mm2),digits =2 ))
meanDataAreaW013_G4A_TR$SD<- round(sd(DataAreaW013_G4A_TR$Area.mm2),digits =2 )
meanDataAreaW013_G4A_TR$Wash <- "W013"
meanDataAreaW013_G4A_TR$Condition <- "W013_G4A"

meanDataAreaW015_G4A_TR<- data.frame(meanArea=round(mean(DataAreaW015_G4A_TR$Area.mm2),digits =2 ))
meanDataAreaW015_G4A_TR$SD<- round(sd(DataAreaW015_G4A_TR$Area.mm2),digits =2 )
meanDataAreaW015_G4A_TR$Wash <- "W015"
meanDataAreaW015_G4A_TR$Condition <- "W015_G4A"

FibreCount_TransferArea_G4A <- rbind(meanDataAreaW000_G4A_TR, meanDataAreaW001_G4A_TR, meanDataAreaW003_G4A_TR, meanDataAreaW005_G4A_TR, meanDataAreaW007_G4A_TR) #,meanDataAreaW009_G4A_TR, meanDataAreaW010_G4A_TR,meanDataAreaW013_G4A_TR,meanDataAreaW015_G4A_TR)

#write.table(FibreCount_TransferArea_G4A, file = "Transfer_Area.csv", quote = F, sep = ",", row.names = F)

# plot
pSH_G4A <- ggplot(FibreCount_TransferArea_G4A, aes(x = factor(Wash, level = c('W000','W001','W003','W005','W007','W009','W010','W013','W015')),
                                                   y= meanArea, fill=Condition))+
  geom_bar(stat="identity", position=position_dodge(),colour="black")+
  geom_text(aes(label = meanArea), hjust=0.5,vjust = -5.5,position = position_dodge(.9))+
  labs(x="\nWash", y="Total fibre area (mm\u00b2)\n") +
  ...
  geom_errorbar(aes(ymin=meanArea-SD, ymax=meanArea+SD),width=.2,position=position_dodge(.9))
pSH_G4A
ggsave("TransferArea_G4A_W000-7.png", pSH_G4A, width = 10, height = 9, units = "in", dpi=150, path = "Results")

###################
#####   G4B   #####
###################
TransferArea_G4B <- read.csv('./Fibre count Summary/TR_G4B_W000-W007_Summary.csv', sep="," ,header = T,fileEncoding="UTF-8-BOM")
TransferArea_G4B$Slice<- gsub(".TIF","",TransferArea_G4B$Slice)
TransferArea_G4BExtended <- data.frame(str_split(TransferArea_G4B$Slice, "_", simplify=TRUE))
names(TransferArea_G4BExtended) <- c("Project","Wash","Garment","Bound","Condition")
TransferArea_G4BTotal <- cbind(TransferArea_G4BExtended,Area=TransferArea_G4B$Total.Area)

# Convert Area from inch2 to mm2
# 1 pixel = 1 x10^-5 inch2, so (Area*1)/0.000011 to convert into px
TransferArea_G4BTotal$Area.px <- (TransferArea_G4BTotal$Area*1)/0.000011
# 1 mm = 112 pixels, 1mm2 = 12544 px
TransferArea_G4BTotal$Area.mm2 <- TransferArea_G4BTotal$Area.px/12544

# Split data per washing condition
DataAreaW000_G4B_TR <- TransferArea_G4BTotal[TransferArea_G4BTotal$Wash =='W000',]
DataAreaW001_G4B_TR <- TransferArea_G4BTotal[TransferArea_G4BTotal$Wash =='W001',]
DataAreaW003_G4B_TR <- TransferArea_G4BTotal[TransferArea_G4BTotal$Wash =='W003',]
DataAreaW005_G4B_TR <- TransferArea_G4BTotal[TransferArea_G4BTotal$Wash =='W005',]
DataAreaW007_G4B_TR <- TransferArea_G4BTotal[TransferArea_G4BTotal$Wash =='W007',]
DataAreaW009_G4B_TR <- TransferArea_G4BTotal[TransferArea_G4BTotal$Wash =='W009',]
DataAreaW010_G4B_TR <- TransferArea_G4BTotal[TransferArea_G4BTotal$Wash =='W010',]
DataAreaW013_G4B_TR <- TransferArea_G4BTotal[TransferArea_G4BTotal$Wash =='W013',]
DataAreaW015_G4B_TR <- TransferArea_G4BTotal[TransferArea_G4BTotal$Wash =='W015',]

# Calculation of mean and SD
meanDataAreaW000_G4B_TR<- data.frame(meanArea=round(mean(DataAreaW000_G4B_TR$Area.mm2),digits =2 ))
meanDataAreaW000_G4B_TR$SD<- round(sd(DataAreaW000_G4B_TR$Area.mm2),digits =2 )
meanDataAreaW000_G4B_TR$Wash <- "W000"
meanDataAreaW000_G4B_TR$Condition <- "W000_G4B"

meanDataAreaW001_G4B_TR<- data.frame(meanArea=round(mean(DataAreaW001_G4B_TR$Area.mm2),digits =2 ))
meanDataAreaW001_G4B_TR$SD<- round(sd(DataAreaW001_G4B_TR$Area.mm2),digits =2 )
meanDataAreaW001_G4B_TR$Wash <- "W001"
meanDataAreaW001_G4B_TR$Condition <- "W001_G4B"

meanDataAreaW003_G4B_TR<- data.frame(meanArea=round(mean(DataAreaW003_G4B_TR$Area.mm2),digits =2 ))
meanDataAreaW003_G4B_TR$SD<- round(sd(DataAreaW003_G4B_TR$Area.mm2),digits =2 )
meanDataAreaW003_G4B_TR$Wash <- "W003"
meanDataAreaW003_G4B_TR$Condition <- "W003_G4B"

meanDataAreaW005_G4B_TR<- data.frame(meanArea=round(mean(DataAreaW005_G4B_TR$Area.mm2),digits =2 ))
meanDataAreaW005_G4B_TR$SD<- round(sd(DataAreaW005_G4B_TR$Area.mm2),digits =2 )
meanDataAreaW005_G4B_TR$Wash <- "W005"
meanDataAreaW005_G4B_TR$Condition <- "W005_G4B"

meanDataAreaW007_G4B_TR<- data.frame(meanArea=round(mean(DataAreaW007_G4B_TR$Area.mm2),digits =2 ))
meanDataAreaW007_G4B_TR$SD<- round(sd(DataAreaW007_G4B_TR$Area.mm2),digits =2 )
meanDataAreaW007_G4B_TR$Wash <- "W007"
meanDataAreaW007_G4B_TR$Condition <- "W007_G4B"

meanDataAreaW009_G4B_TR<- data.frame(meanArea=round(mean(DataAreaW009_G4B_TR$Area.mm2),digits =2 ))
meanDataAreaW009_G4B_TR$SD<- round(sd(DataAreaW009_G4B_TR$Area.mm2),digits =2 )
meanDataAreaW009_G4B_TR$Wash <- "W009"
meanDataAreaW009_G4B_TR$Condition <- "W009_G4B"

meanDataAreaW010_G4B_TR<- data.frame(meanArea=round(mean(DataAreaW010_G4B_TR$Area.mm2),digits =2 ))
meanDataAreaW010_G4B_TR$SD<- round(sd(DataAreaW010_G4B_TR$Area.mm2),digits =2 )
meanDataAreaW010_G4B_TR$Wash <- "W010"
meanDataAreaW010_G4B_TR$Condition <- "W010_G4B"

meanDataAreaW013_G4B_TR<- data.frame(meanArea=round(mean(DataAreaW013_G4B_TR$Area.mm2),digits =2 ))
meanDataAreaW013_G4B_TR$SD<- round(sd(DataAreaW013_G4B_TR$Area.mm2),digits =2 )
meanDataAreaW013_G4B_TR$Wash <- "W013"
meanDataAreaW013_G4B_TR$Condition <- "W013_G4B"

meanDataAreaW015_G4B_TR<- data.frame(meanArea=round(mean(DataAreaW015_G4B_TR$Area.mm2),digits =2 ))
meanDataAreaW015_G4B_TR$SD<- round(sd(DataAreaW015_G4B_TR$Area.mm2),digits =2 )
meanDataAreaW015_G4B_TR$Wash <- "W015"
meanDataAreaW015_G4B_TR$Condition <- "W015_G4B"

FibreCount_TransferArea_G4B <- rbind(meanDataAreaW000_G4B_TR, meanDataAreaW001_G4B_TR, meanDataAreaW003_G4B_TR, meanDataAreaW005_G4B_TR, meanDataAreaW007_G4B_TR) #,meanDataAreaW009_G4B_TR, meanDataAreaW010_G4B_TR,meanDataAreaW013_G4B_TR,meanDataAreaW015_G4B_TR)

#write.table(FibreCount_TransferArea_G4B, file = "Transfer_Area.csv", quote = F, sep = ",", row.names = F)

# plot
pSH_G4B <- ggplot(FibreCount_TransferArea_G4B, aes(x = factor(Wash, level = c('W000','W001','W003','W005','W007','W009','W010','W013','W015')),
                                                   y= meanArea, fill=Condition))+
  geom_bar(stat="identity", position=position_dodge(),colour="black")+
  geom_text(aes(label = meanArea), hjust=0.5,vjust = -5.5,position = position_dodge(.9))+
  labs(x="\nWash", y="Total fibre area (mm\u00b2)\n") +
  ...
  geom_errorbar(aes(ymin=meanArea-SD, ymax=meanArea+SD),width=.2,position=position_dodge(.9))
pSH_G4B
ggsave("TransferArea_G4B_W000-15.png", pSH_G4B, width = 10, height = 9, units = "in", dpi=150, path = "Results")

##################
#####   G4C   #####
##################
TransferArea_G4C <- read.csv('./Fibre count Summary/TR_G4C_W000-W007_Summary.csv', sep="," ,header = T,fileEncoding="UTF-8-BOM")
TransferArea_G4C$Slice<- gsub(".TIF","",TransferArea_G4C$Slice)
TransferArea_G4CExtended <- data.frame(str_split(TransferArea_G4C$Slice, "_", simplify=TRUE))
names(TransferArea_G4CExtended) <- c("Project","Wash","Garment","Bound","Condition")
TransferArea_G4CTotal <- cbind(TransferArea_G4CExtended,Area=TransferArea_G4C$Total.Area)

# Convert Area from inch2 to mm2
# 1 pixel = 1 x10^-5 inch2, so (Area*1)/0.000011 to convert into px
TransferArea_G4CTotal$Area.px <- (TransferArea_G4CTotal$Area*1)/0.000011
# 1 mm = 112 pixels, 1mm2 = 12544 px
TransferArea_G4CTotal$Area.mm2 <- TransferArea_G4CTotal$Area.px/12544

# Split data per washing condition
DataAreaW000_G4C_TR <- TransferArea_G4CTotal[TransferArea_G4CTotal$Wash =='W000',]
DataAreaW001_G4C_TR <- TransferArea_G4CTotal[TransferArea_G4CTotal$Wash =='W001',]
DataAreaW003_G4C_TR <- TransferArea_G4CTotal[TransferArea_G4CTotal$Wash =='W003',]
DataAreaW005_G4C_TR <- TransferArea_G4CTotal[TransferArea_G4CTotal$Wash =='W005',]
DataAreaW007_G4C_TR <- TransferArea_G4CTotal[TransferArea_G4CTotal$Wash =='W007',]
DataAreaW009_G4C_TR <- TransferArea_G4CTotal[TransferArea_G4CTotal$Wash =='W009',]
DataAreaW010_G4C_TR <- TransferArea_G4CTotal[TransferArea_G4CTotal$Wash =='W010',]
DataAreaW013_G4C_TR <- TransferArea_G4CTotal[TransferArea_G4CTotal$Wash =='W013',]
DataAreaW015_G4C_TR <- TransferArea_G4CTotal[TransferArea_G4CTotal$Wash =='W015',]

# Calculation of mean and SD
meanDataAreaW000_G4C_TR<- data.frame(meanArea=round(mean(DataAreaW000_G4C_TR$Area.mm2),digits =2 ))
meanDataAreaW000_G4C_TR$SD<- round(sd(DataAreaW000_G4C_TR$Area.mm2),digits =2 )
meanDataAreaW000_G4C_TR$Wash <- "W000"
meanDataAreaW000_G4C_TR$Condition <- "W000_G4C"

meanDataAreaW001_G4C_TR<- data.frame(meanArea=round(mean(DataAreaW001_G4C_TR$Area.mm2),digits =2 ))
meanDataAreaW001_G4C_TR$SD<- round(sd(DataAreaW001_G4C_TR$Area.mm2),digits =2 )
meanDataAreaW001_G4C_TR$Wash <- "W001"
meanDataAreaW001_G4C_TR$Condition <- "W001_G4C"

meanDataAreaW003_G4C_TR<- data.frame(meanArea=round(mean(DataAreaW003_G4C_TR$Area.mm2),digits =2 ))
meanDataAreaW003_G4C_TR$SD<- round(sd(DataAreaW003_G4C_TR$Area.mm2),digits =2 )
meanDataAreaW003_G4C_TR$Wash <- "W003"
meanDataAreaW003_G4C_TR$Condition <- "W003_G4C"

meanDataAreaW005_G4C_TR<- data.frame(meanArea=round(mean(DataAreaW005_G4C_TR$Area.mm2),digits =2 ))
meanDataAreaW005_G4C_TR$SD<- round(sd(DataAreaW005_G4C_TR$Area.mm2),digits =2 )
meanDataAreaW005_G4C_TR$Wash <- "W005"
meanDataAreaW005_G4C_TR$Condition <- "W005_G4C"

meanDataAreaW007_G4C_TR<- data.frame(meanArea=round(mean(DataAreaW007_G4C_TR$Area.mm2),digits =2 ))
meanDataAreaW007_G4C_TR$SD<- round(sd(DataAreaW007_G4C_TR$Area.mm2),digits =2 )
meanDataAreaW007_G4C_TR$Wash <- "W007"
meanDataAreaW007_G4C_TR$Condition <- "W007_G4C"

meanDataAreaW009_G4C_TR<- data.frame(meanArea=round(mean(DataAreaW009_G4C_TR$Area.mm2),digits =2 ))
meanDataAreaW009_G4C_TR$SD<- round(sd(DataAreaW009_G4C_TR$Area.mm2),digits =2 )
meanDataAreaW009_G4C_TR$Wash <- "W009"
meanDataAreaW009_G4C_TR$Condition <- "W009_G4C"

meanDataAreaW010_G4C_TR<- data.frame(meanArea=round(mean(DataAreaW010_G4C_TR$Area.mm2),digits =2 ))
meanDataAreaW010_G4C_TR$SD<- round(sd(DataAreaW010_G4C_TR$Area.mm2),digits =2 )
meanDataAreaW010_G4C_TR$Wash <- "W010"
meanDataAreaW010_G4C_TR$Condition <- "W010_G4C"

meanDataAreaW013_G4C_TR<- data.frame(meanArea=round(mean(DataAreaW013_G4C_TR$Area.mm2),digits =2 ))
meanDataAreaW013_G4C_TR$SD<- round(sd(DataAreaW013_G4C_TR$Area.mm2),digits =2 )
meanDataAreaW013_G4C_TR$Wash <- "W013"
meanDataAreaW013_G4C_TR$Condition <- "W013_G4C"

meanDataAreaW015_G4C_TR<- data.frame(meanArea=round(mean(DataAreaW015_G4C_TR$Area.mm2),digits =2 ))
meanDataAreaW015_G4C_TR$SD<- round(sd(DataAreaW015_G4C_TR$Area.mm2),digits =2 )
meanDataAreaW015_G4C_TR$Wash <- "W015"
meanDataAreaW015_G4C_TR$Condition <- "W015_G4C"

FibreCount_TransferArea_G4C <- rbind(meanDataAreaW000_G4C_TR, meanDataAreaW001_G4C_TR, meanDataAreaW003_G4C_TR, meanDataAreaW005_G4C_TR, meanDataAreaW007_G4C_TR) #,meanDataAreaW009_G4C_TR, meanDataAreaW010_G4C_TR,meanDataAreaW013_G4C_TR,meanDataAreaW015_G4C_TR)

#write.table(FibreCount_TransferArea_G4C, file = "Transfer_Area.csv", quote = F, sep = ",", row.names = F)

# plot
pSH_G4C <- ggplot(FibreCount_TransferArea_G4C, aes(x = factor(Wash, level = c('W000','W001','W003','W005','W007','W009','W010','W013','W015')),
                                                   y= meanArea, fill=Condition))+
  geom_bar(stat="identity", position=position_dodge(),colour="black")+
  geom_text(aes(label = meanArea), hjust=0.5,vjust = -5.5,position = position_dodge(.9))+
  labs(x="\nWash", y="Total fibre area (mm\u00b2)\n") +
  ...
  geom_errorbar(aes(ymin=meanArea-SD, ymax=meanArea+SD),width=.2,position=position_dodge(.9))
pSH_G4C
ggsave("TransferArea_G4C_W000-7.png", pSH_G4C, width = 10, height = 9, units = "in", dpi=150, path = "Results")
