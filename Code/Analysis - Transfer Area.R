...
#####   G1   #####
##################
TransferArea_G1 <- read.csv('./Fibre count Summary/TR_G1_W000-W011_Summary.csv', sep="," ,header = T,fileEncoding="UTF-8-BOM")
...
FibreCount_TransferArea_G1 <- rbind(meanDataAreaW000_G1_TR, meanDataAreaW001_G1_TR, meanDataAreaW003_G1_TR, meanDataAreaW005_G1_TR, meanDataAreaW007_G1_TR,meanDataAreaW009_G1_TR,meanDataAreaW011_G1_TR)
