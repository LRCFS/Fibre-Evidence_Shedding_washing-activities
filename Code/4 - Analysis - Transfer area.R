...
Transfer_G1$value <-  Transfer_G1$`After transfer area` -  Transfer_G1$`Before transfer area`
Transfer_G2$value <-  Transfer_G2$`After transfer area` -  Transfer_G2$`Before transfer area`
Transfer_G3$value <-  Transfer_G3$`After transfer area` -  Transfer_G3$`Before transfer area`
Transfer_G4$value <-  Transfer_G4$`After transfer area` -  Transfer_G4$`Before transfer area`
Transfer_G4$value <-  Transfer_G4$`After transfer area` -  Transfer_G4$`Before transfer area`
Transfer_G5$value <-  Transfer_G5$`After transfer area` -  Transfer_G5$`Before transfer area`
Transfer_G6$value <-  Transfer_G6$`After transfer area` -  Transfer_G6$`Before transfer area`
...
# to export 
Transfer_G1 <- Transfer_G1 %>% dplyr::select(wash, garment,`Before transfer area`,`After transfer area`,value)
Transfer_G2 <- Transfer_G2 %>% dplyr::select(wash, garment,`Before transfer area`,`After transfer area`,value)
Transfer_G3 <- Transfer_G3 %>% dplyr::select(wash, garment,`Before transfer area`,`After transfer area`,value)
Transfer_G4 <- Transfer_G4 %>% dplyr::select(wash, garment,`Before transfer area`,`After transfer area`,value)
Transfer_G5 <- Transfer_G5 %>% dplyr::select(wash, garment,`Before transfer area`,`After transfer area`,value)
Transfer_G6 <- Transfer_G6 %>% dplyr::select(wash, garment,`Before transfer area`,`After transfer area`,value)
